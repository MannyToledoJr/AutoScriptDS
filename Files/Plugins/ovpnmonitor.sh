...
apt-get install git libgeoip-dev python-virtualenv python-dev geoip-database-extra nginx uwsgi uwsgi-plugin-python gcc -y
...
# Create openvpn-monitor conf
cat > /srv/openvpn-monitor/openvpn-monitor.conf <<-END
[openvpn-monitor]
site=DebianVPN
#logo=logo.jpg
#latitude=40.72
...
# (Optional) Modify Openvpn Monitor Conf
